...
// FIX: Renamed imported `Blob` type to `GoogleGenAIBlob` to avoid conflict with the native DOM `Blob` object.
import type {Blob as GoogleGenAIBlob} from '@google/genai';

interface AudioServiceOptions {
  onInputAudio: (blob: GoogleGenAIBlob) => void;
}
...
export class AudioService {
  private onInputAudio: (blob: GoogleGenAIBlob) => void;
